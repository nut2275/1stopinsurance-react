...
// แก้ไข: นำเข้า useNavigate และ useSearchParams จาก react-router-dom
...
import { Customer } from '../../types/dataType'; // ⚠️ ต้องมี Customer type

// ลบ 'use client'
export default function EditProfileForm() {
    // แก้ไข: ใช้ useNavigate()
    const navigate = useNavigate();
    // แก้ไข: ใช้ useSearchParams() จาก react-router-dom
    const [searchParams] = useSearchParams(); 

    // 1. ตั้งค่าเริ่มต้น (ไม่มีการเปลี่ยนแปลง)
    ...
    useEffect(() => {
        // ใช้ searchParams.get() ได้ตามเดิม
        if (searchParams.get('first_name')) { 
            const id = searchParams.get('_id'); // หรือ 'id' ตามที่คุณส่งมา
            const birthDateStr = searchParams.get('birth_date');
            const imgProfile = searchParams.get('imgProfile_customer');
            
            // Note: ต้อง Decode URL component ถ้ามีอักขระพิเศษในชื่อหรือที่อยู่
            ...
            setProfilePreview(decode(imgProfile) || "/fotos/noPrafile.jpg");
        }
    }, [searchParams]);

    // Helper Date (ไม่มีการเปลี่ยนแปลง)
    ...
    // ✅ handleSubmit ที่ใช้ api instance (ไม่มีการเปลี่ยนแปลง Logic)
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            // จัดการ Error (ไม่มีการเปลี่ยนแปลง Logic)
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="text-center pb-4 border-b border-gray-100">
                        ...
                        <img
                            ...
                            style={{ width: '6rem', height: '6rem' }} // กำหนดขนาดด้วย style/CSS
                        />
...
>>>>>>> d982cee2c60653760d3ed45ae44f85ed7c3a9fdc
