...
export default function MainPage() {
  return (
    <div className="flex flex-col min-h-screen font-sans text-gray-800 bg-gray-50">
      ...
      {/* Header: ✅ แก้ไข Bug โดยการลบ activePage ออกตามที่ TypeScript แจ้งเตือน */}
      <MenuLogined />
      ...
      <main className="flex-grow">
        ...
        <section className="text-center py-16 px-6 bg-white">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-6 mt-10">
            <img src="/fotos/Insur1.png" alt="Partner 1" style={{ width: 60, height: 60 }}/>
            <img src="/fotos/Insur2.png" alt="Partner 2" style={{ width: 60, height: 60 }}/>
            <img src="/fotos/Insur3.png" alt="Partner 3" style={{ width: 60, height: 60 }}/>
            <img src="/fotos/Insur4.png" alt="Partner 4" style={{ width: 60, height: 60 }}/>
            <img src="/fotos/Insur5.png" alt="Partner 5" style={{ width: 60, height: 60 }}/>
            <img src="/fotos/Insur6.png" alt="Partner 6" style={{ width: 60, height: 60 }}/>
          </div>
        </section>
      </main>
    </div>
